...
echo "[TASK 1] Initial Kubernetes - Pod CIDR 172.30.0.0/16 , API Server 192.168.10.100"
kubeadm init --token 123456.1234567890123456 --token-ttl 0 --pod-network-cidr=172.30.0.0/16 --apiserver-advertise-address=192.168.10.100 >/dev/null 2>&1
